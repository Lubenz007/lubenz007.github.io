...
summary: "Monitor Azure AD app registrations for certificate and secret expiration dates to prevent service disruptions with automated PowerShell reporting."
---

Monitor Azure AD application registrations for expiring certificates and secrets to prevent service disruptions. This script identifies expiring, expired, and apps with no expiration dates.

<!--more-->

## Azure AD Application Expiration Monitoring
